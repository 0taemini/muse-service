...
public enum ErrorCode {
    ...
    BULK_SMS_NO_RECIPIENTS(HttpStatus.BAD_REQUEST, "SMS_001", "발송 가능한 대상자가 없습니다."),
    BULK_SMS_SEND_FAILED(HttpStatus.BAD_GATEWAY, "SMS_002", "단체 문자 발송에 실패했습니다."),
    ...
    CHAT_ROOM_NOT_FOUND(HttpStatus.NOT_FOUND, "CHAT_003", "채팅방을 찾을 수 없습니다."),
    CHAT_ROOM_ACCESS_DENIED(HttpStatus.FORBIDDEN, "CHAT_004", "채팅방에 접근할 권한이 없습니다."),
    CHAT_ROUND_NOT_FOUND(HttpStatus.NOT_FOUND, "CHAT_005", "채팅 라운드를 찾을 수 없습니다."),
    CHAT_ROUND_NOT_OPEN(HttpStatus.CONFLICT, "CHAT_006", "열려 있는 채팅 라운드가 없습니다."),
    CHAT_ROUND_COOLDOWN(HttpStatus.TOO_MANY_REQUESTS, "CHAT_007", "새 라운드는 채팅방별로 6시간마다 한 번만 시작할 수 있습니다."),
    CHAT_MESSAGE_EMPTY(HttpStatus.BAD_REQUEST, "CHAT_008", "메시지 내용을 입력해 주세요."),
    CHAT_ROUND_ALREADY_SUMMARIZED(HttpStatus.CONFLICT, "CHAT_009", "이미 이 라운드의 AI 피드백이 생성되었습니다."),
    CHAT_ROUND_NO_MESSAGES(HttpStatus.BAD_REQUEST, "CHAT_010", "AI 피드백을 생성할 메시지가 없습니다."),
    CHAT_TARGET_SESSION_NOT_ASSIGNED(HttpStatus.BAD_REQUEST, "CHAT_011", "담당자가 배정된 세션에만 피드백을 보낼 수 있습니다."),
