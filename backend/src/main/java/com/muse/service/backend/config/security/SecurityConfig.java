    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/photo-albums/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/images/*/variants").permitAll()
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/images/*/failed").permitAll()
