    ...
    <section className="space-y-12 md:space-y-16">
      ...
      {isAuthenticated ? (
        <section className="md:hidden">
          <Link
            to="/performances"
            state={{ mobileQuickAction: 'chatRooms' }}
            className="block rounded-[8px] border border-[#d9d0ff] bg-[#5a43ba] px-5 py-4 text-white shadow-[0_18px_38px_rgba(90,67,186,0.22)]"
          >
